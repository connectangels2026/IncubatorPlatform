      ...
      <nav className="sticky top-0 z-50 bg-slate-900/80 backdrop-blur-md border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex gap-8">
            ...
            <a href="#programs" className="hover:text-blue-400 transition">Programs</a>
            <a href="#cta" className="hover:text-blue-400 transition">Get Started</a>
          </div>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden px-4">
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          <div className="mb-6 inline-block">
            <span className="px-4 py-2 rounded-full bg-blue-500/10 border border-blue-400/50 text-blue-300 text-sm font-medium">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-16 pt-12 border-t border-slate-700">
            <div>
              ...
              <div className="text-slate-400">Startups Launched</div>
            </div>
            <div>
      ...
      <section id="features" className="py-20 px-4 bg-slate-800/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300">Comprehensive support at every stage of your startup journey</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={idx}
                className="p-6 rounded-lg bg-slate-700/50 border border-slate-600 hover:border-blue-400/50 transition group cursor-pointer"
              >
      ...
      <section id="programs" className="py-20 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300">Choose the program that fits your stage</p>
          </div>

          <div className="grid md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            {/* Pre-Incubator */}
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-cyan-600 rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000"></div>
              <div className="relative bg-slate-800 p-8 rounded-lg border border-slate-700">
                <div className="text-3xl font-bold text-blue-400 mb-2">Pre-Incubator</div>
                <div className="text-slate-400 mb-6">For early-stage ideas</div>
                <ul className="space-y-3 mb-8">
                  ...
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400" />
                    <span>Free workspace access</span>
                  </li>
                </ul>
                <Link href="/programs">
            ...
            {/* Incubator */}
            <div className="relative group">
              <div className="absolute inset-0 bg-gradient-to-r from-cyan-600 to-purple-600 rounded-lg blur opacity-25 group-hover:opacity-75 transition duration-1000"></div>
              <div className="relative bg-slate-800 p-8 rounded-lg border border-slate-700 lg:scale-105">
                ...
                <div className="text-slate-400 mb-6">For validated startups</div>
                <ul className="space-y-3 mb-8">
                  <li className="flex items-center gap-3">
                    <CheckCircle className="w-5 h-5 text-green-400" />
      ...
      <section className="py-20 px-4 bg-slate-800/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-slate-300">Meet some of our successful founders</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={idx} className="p-6 rounded-lg bg-slate-700/50 border border-slate-600">
                ...
                <p className="text-slate-400 text-sm mb-3">{story.founder}</p>
                <p className="text-blue-400 font-semibold">{story.growth}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-slate-400">Building tomorrow's startups today.</p>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                <li><a href="/programs" className="hover:text-blue-400 transition">Pre-Incubator</a></li>
                <li><a href="/programs" className="hover:text-blue-400 transition">Incubator</a></li>
              </ul>
            </div>
            <div>
